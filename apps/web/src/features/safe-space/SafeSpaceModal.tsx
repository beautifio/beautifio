...
export function SafeSpaceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full max-w-md bg-white rounded-t-2xl sm:rounded-2xl px-5 pt-5 pb-24 max-h-[80vh] overflow-y-auto animate-in fade-in slide-in-from-bottom-8 duration-300">
        <button
          onClick={onClose}
