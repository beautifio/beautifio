...
export function NavWrapper({ children }: { children: React.ReactNode }) {
  ...
  const hideNav = pathname === "/login" || pathname === "/register" || pathname === "/forgot-password" || pathname.startsWith("/auth/") || pathname.startsWith("/coba/") || pathname === "/" || pathname.startsWith("/mimpi");
