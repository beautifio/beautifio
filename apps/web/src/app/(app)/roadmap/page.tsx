...
const ALL_DREAMS = [
  ...
  { slug: "content-creator", label: "Content Creator", emoji: "🎨", color: "from-secondary to-accent", users: 2800, completionRate: 70, activeLearners: 420 },
  { slug: "entrepreneur", label: "Entrepreneur", emoji: "💼", color: "from-accent to-primary", users: 1580, completionRate: 58, activeLearners: 210 },
  { slug: "musician", label: "Musisi", emoji: "🎵", color: "from-primary to-secondary", users: 1200, completionRate: 75, activeLearners: 180 },
  { slug: "runner", label: "Pelari", emoji: "🏃", color: "from-accent to-primary", users: 950, completionRate: 80, activeLearners: 140 },
  { slug: "digital-marketer", label: "Digital Marketer", emoji: "📱", color: "from-primary to-accent", users: 1400, completionRate: 62, activeLearners: 190 },
  { slug: "athlete", label: "Atlet", emoji: "🏅", color: "from-secondary to-primary", users: 780, completionRate: 85, activeLearners: 95 },
  { slug: "beauty-creator", label: "Beauty Creator", emoji: "💄", color: "from-accent to-secondary", users: 1100, completionRate: 73, activeLearners: 160 },
  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="max-w-content mx-auto px-6 pt-6 pb-24">
        {/* Deprecation banner */}
        <div className="p-3 rounded-xl bg-amber-50 border border-amber-200 dark:bg-amber-950/30 dark:border-amber-800/50 flex items-start gap-2 mb-6">
