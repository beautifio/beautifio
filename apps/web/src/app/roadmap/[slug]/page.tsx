...
import type { RoadmapTemplate, RoadmapTemplateMilestone, RoadmapTemplateRecommendation, RoadmapTask } from "@beautifio/types";
...
const mockMilestones: Record<string, RoadmapTemplateMilestone[]> = {
  doctor: [
  ...
  programmer: [
    { id: "prog-m1", template_id: "programmer", title: "Fundamental Programming", description: "Mempelajari dasar-dasar pemrograman.", order_index: 1, tasks: [{ title: "Pilih bahasa pemrograman pertama" }, { title: "Kuasai variabel, fungsi, loop, conditional" }, { title: "Pahami struktur data dasar" }, { title: "Selesaikan 50+ soal coding" }], estimated_days: 60, created_at: "" },
    { id: "prog-m2", template_id: "programmer", title: "Frontend atau Backend", description: "Memilih dan mendalami jalur frontend atau backend.", order_index: 2, tasks: [{ title: "Frontend: Kuasai HTML, CSS, JavaScript" }, { title: "Backend: Kuasai API, database, server" }, { title: "Buat project portofolio" }, { title: "Pelajari version control (Git)" }], estimated_days: 90, created_at: "" },
    ...
    { id: "prog-m4", template_id: "programmer", title: "Karir Profesional", description: "Memulai karir sebagai programmer profesional.", order_index: 4, tasks: [{ title: "Bangun portofolio dan GitHub" }, { title: "Siapkan CV dan LinkedIn" }, { title: "Lamaran kerja dan interview" }, { title: "Kontribusi ke open source" }], estimated_days: 180, created_at: "" },
  ],
  "content-creator": [
  ...
  entrepreneur: [
    ...
    { id: "ent-m2", template_id: "entrepreneur", title: "MVP & Launch", description: "Membangun produk minimum dan meluncurkan bisnis.", order_index: 2, tasks: [{ title: "Buat MVP (Minimum Viable Product)" }, { title: "Tentukan model bisnis dan harga" }, { title: "Urus legalitas usaha" }, { title: "Launch produk ke pasar" }], estimated_days: 90, created_at: "" },
    ...
    { id: "ent-m4", template_id: "entrepreneur", title: "Skalasi Bisnis", description: "Memperluas bisnis dan mencari pendanaan.", order_index: 4, tasks: [{ title: "Rekrut tim inti" }, { title: "Ekspansi ke pasar baru" }, { title: "Ajukan pendanaan (angel/VC)" }, { title: "Bangun sistem dan operasional skalabel" }], estimated_days: 365, created_at: "" },
  ],
  "digital-marketer": [
    { id: "dm-m1", template_id: "digital-marketer", title: "Fundamental Marketing", description: "Dasar-dasar pemasaran digital.", order_index: 1, tasks: [{ title: "Pelajari marketing funnel dan customer journey" }, { title: "Kuasai SEO dasar" }, { title: "Pahami social media marketing" }, { title: "Belajar Google Analytics" }], estimated_days: 60, created_at: "" },
    { id: "dm-m2", template_id: "digital-marketer", title: "Spesialisasi Channel", description: "Mendalami channel pemasaran tertentu.", order_index: 2, tasks: [{ title: "Pilih spesialisasi (SEO/SEM/Social/Email)" }, { title: "Kuasai Google Ads atau Meta Ads" }, { title: "Sertifikasi Google Digital Marketing" }, { title: "Kelola campaign nyata" }], estimated_days: 90, created_at: "" },
  ...
  "beauty-creator": [
    ...
    { id: "bc-m3", template_id: "beauty-creator", title: "Kolaborasi & Brand", description: "Berkolaborasi dengan brand kecantikan.", order_index: 3, tasks: [{ title: "Bangun media kit" }, { title: "Tawarkan jasa review ke brand kecil" }, { title: "Ikuti beauty event dan gathering" }, { title: "Capai 5.000 followers" }], estimated_days: 90, created_at: "" },
  ...
  musician: [
    { id: "mus-m1", template_id: "musician", title: "Dasar Musik", description: "Teori musik dan memilih alat musik.", order_index: 1, tasks: [{ title: "Pelajari teori musik dasar" }, { title: "Pilih alat musik utama" }, { title: "Kuasai teknik dasar alat musik" }, { title: "Mainkan lagu sederhana" }], estimated_days: 120, created_at: "" },
    ...
    { id: "mus-m4", template_id: "musician", title: "Karir Musik", description: "Monetisasi bakat musik dan membangun karir.", order_index: 4, tasks: [{ title: "Rilis lagu di platform digital" }, { title: "Bangun audiens di media sosial" }, { title: "Cari manajer atau label" }, { title: "Tur dan pertunjukan berbayar" }], estimated_days: 730, created_at: "" },
  ],
  "football-player": [
...
const mockRecommendations: Record<string, RoadmapTemplateRecommendation[]> = {
  doctor: [
...
export default function RoadmapDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const milestones = mockMilestones[slug] ?? [];
  const recommendations = mockRecommendations[slug] ?? [];
    ...
    <div className="min-h-screen bg-bg">
      <div className="max-w-[390px] mx-auto">
        ...
        <div className="px-6 pt-6 pb-24 space-y-8">
          <MilestoneTimeline milestones={milestones} progress={progress} />
