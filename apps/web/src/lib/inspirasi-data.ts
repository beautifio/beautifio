...
export const CATEGORY_LABELS: Record<string, string> = {
  ...
  "Bisnis": "Level Up & Career",
  "Personal Growth": "Mind & Body",
  "Self Reflection": "Mind & Body",
  "Gaming": "Tech & Gaming",
  "Teknologi": "Tech & Gaming",
  "Finance": "Level Up & Career",
  "Keluarga": "Relationship",
  "Percintaan": "Relationship",
  "Menulis & Literasi": "Creative Space",
  "Writing": "Creative Space",
  "Alam & Petualangan": "Wellness",
};

export const CATEGORY_COLORS: Record<string, { primary: string }> = {
  "mind-body": { primary: "#084463" },
  "glow-glowup": { primary: "#F5A3C7" },
  "levelup-career": { primary: "#0B4F8A" },
  ...
  "cerita_pembaca": { primary: "#C89C72" },
  "Kesehatan Mental": { primary: "#084463" },
  "Pendidikan": { primary: "#0B4F8A" },
  "Karir": { primary: "#0B4F8A" },
  "Bisnis": { primary: "#0B4F8A" },
  "Personal Growth": { primary: "#084463" },
  "Self Reflection": { primary: "#084463" },
  "Gaming": { primary: "#00B7D9" },
  "Teknologi": { primary: "#00B7D9" },
  "Finance": { primary: "#0B4F8A" },
  "Keluarga": { primary: "#F49B7A" },
  "Percintaan": { primary: "#F49B7A" },
  "Menulis & Literasi": { primary: "#A68AE3" },
  "Writing": { primary: "#A68AE3" },
  "Alam & Petualangan": { primary: "#5DBB89" },
};
