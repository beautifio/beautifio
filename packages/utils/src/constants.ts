...
export const ROADMAP_TEMPLATES: RoadmapTemplateConstant[] = [
  ...
  { slug: "entrepreneur", title: "Entrepreneur", description: "Membangun bisnis dari ide hingga pertumbuhan", icon: "TrendingUp", color: "from-amber-600 to-yellow-500", label: "Bisnis", duration: "1-3 tahun", category: "business" },
