import type {
  FamiliaMerchant, FamiliaAffiliateDeal, FamiliaAchievementReward, FamiliaEventBenefit,
  FamiliaVoucherSession, VoucherType,
} from "@beautifio/types";

export const FAMILIA_MERCHANTS: FamiliaMerchant[] = [
...
export const FAMILIA_AFFILIATE_DEALS: FamiliaAffiliateDeal[] = [
  { id: "fd1", title: "Sepatu Lari Terbaik 2026", slug: "sepatu-lari", description: "Dapatkan diskon eksklusif sepatu lari dari brand ternama. Cocok untuk kamu yang sedang menjalani program lari.", image_url: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80", category: "olahraga", partner_name: "SportsDirect", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "kesehatan", is_featured: true, click_count: 234, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd2", title: "Buku Panduan Masuk Fakultas Kedokteran", slug: "buku-kedokteran", description: "Buku persiapan masuk FK dengan tips dari dokter senior dan alumni FK ternama.", image_url: "https://images.unsplash.com/photo-1532012197267-da84d127e765?w=400&q=80", category: "pendidikan", partner_name: "Gramedia", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "pendidikan", is_featured: true, click_count: 189, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd3", title: "Paket Canva Pro 6 Bulan", slug: "canva-pro", description: "Canva Pro untuk konten kreator dengan harga spesial. Desain tanpa batas.", image_url: "https://images.unsplash.com/photo-1611532736597-de2d4265fba3?w=400&q=80", category: "kreator", partner_name: "Canva", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "skill", is_featured: true, click_count: 456, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd4", title: "Mikrofon USB Profesional", slug: "mikrofon-usb", description: "Mikrofon berkualitas untuk content creator pemula. Plug and play, cocok untuk podcast dan recording.", image_url: "https://images.unsplash.com/photo-1590602847861-f357a9332bbc?w=400&q=80", category: "kreator", partner_name: "Shopee", partner_url: "https://shopee.co.id", platform: "shopee", goal_category: "skill", is_featured: true, click_count: 312, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd5", title: "Perlengkapan Futsal", slug: "perlengkapan-futsal", description: "Sepatu, jersey, dan bola futsal dengan harga afiliasi. Untuk atlet muda Indonesia.", image_url: "https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=400&q=80", category: "olahraga", partner_name: "SportsStation", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "kesehatan", is_featured: false, click_count: 87, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd6", title: "Set Peralatan Golf Pemula", slug: "peralatan-golf", description: "Set stick golf dan aksesoris untuk pegolf pemula yang ingin memulai hobi baru.", image_url: "https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=400&q=80", category: "olahraga", partner_name: "Shopee", partner_url: "https://shopee.co.id", platform: "shopee", goal_category: "kesehatan", is_featured: false, click_count: 45, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd7", title: "Skincare Routine Set", slug: "skincare-set", description: "Paket skincare lengkap untuk kulit sehat bercahaya. Cocok untuk beauty enthusiast.", image_url: "https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&q=80", category: "kecantikan", partner_name: "Tokopedia", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "bisnis", is_featured: true, click_count: 523, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd8", title: "Keyboard Mechanical untuk Coding", slug: "keyboard-mekanikal", description: "Keyboard nyaman untuk programmer dan produktivitas sehari-hari. Switch customizable.", image_url: "https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=400&q=80", category: "teknologi", partner_name: "Tokopedia", partner_url: "https://www.tokopedia.com", platform: "tokopedia", goal_category: "skill", is_featured: true, click_count: 278, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd9", title: "Laptop Ringan untuk Mahasiswa", slug: "laptop-mahasiswa", description: "Laptop ringan dan bertenaga untuk kebutuhan belajar dan organisasi.", image_url: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=400&q=80", category: "teknologi", partner_name: "Shopee", partner_url: "https://shopee.co.id", platform: "shopee", goal_category: "pendidikan", is_featured: false, click_count: 156, is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "fd10", title: "Kursus Public Speaking Online", slug: "public-speaking", description: "Belajar public speaking dari mentor berpengalaman. Bangun kepercayaan dirimu.", image_url: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=400&q=80", category: "pendidikan", partner_name: "TikTok Shop", partner_url: "https://www.tiktok.com", platform: "tiktok", goal_category: "pendidikan", is_featured: false, click_count: 134, is_active: true, created_at: "2026-06-01T00:00:00Z" },
];

export const FAMILIA_ACHIEVEMENT_REWARDS: FamiliaAchievementReward[] = [
...
export const FAMILIA_EVENT_BENEFITS: FamiliaEventBenefit[] = [
  { id: "ev1", title: "Workshop Personal Branding", description: "Workshop offline personal branding untuk anggota Familia. Bersama mentor berpengalaman.", event_date: "2026-08-15T09:00:00Z", discount_type: "percentage", discount_value: "25%", code: "FAMBRAND25", is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "ev2", title: "Career Expo 2026", description: "Pameran karir dengan perusahaan top Indonesia. Gratis untuk anggota Familia.", event_date: "2026-09-20T09:00:00Z", discount_type: "free", discount_value: "Gratis Tiket Masuk", code: "FAMEXPO26", is_active: true, created_at: "2026-06-01T00:00:00Z" },
  { id: "ev3", title: "Bootcamp Coding Intensif", description: "Bootcamp 3 hari full-stack development dengan mentor profesional.", event_date: "2026-10-10T08:00:00Z", discount_type: "nominal", discount_value: "Rp200.000", code: "FAMCODE200", is_active: true, created_at: "2026-06-01T00:00:00Z" },
];
...
// Voucher session management
const SESSION_KEY = "beautifio_voucher_sessions";

export function getVoucherSessions(): FamiliaVoucherSession[] {
...
export function saveVoucherSession(session: FamiliaVoucherSession): void {
  if (typeof window === "undefined") return;
  try {
    const items = getVoucherSessions();
    items.unshift(session);
    localStorage.setItem(SESSION_KEY, JSON.stringify(items));
  } catch {}
}

export function updateVoucherSession(id: string, updates: Partial<FamiliaVoucherSession>): void {
  if (typeof window === "undefined") return;
  try {
    const items = getVoucherSessions();
...
export function getActiveVoucherForMerchant(merchantId: string): FamiliaVoucherSession | undefined {
  return getVoucherSessions().find((s) => s.merchant_id === merchantId && s.status === "active");
}

export function hasRedeemedToday(merchantId: string): boolean {
  if (typeof window === "undefined") return false;
  try {
    const key = `beautifio_voucher_redemptions_${merchantId}`;
...
export function recordRedemption(merchantId: string): void {
  if (typeof window === "undefined") return;
  try {
    const key = `beautifio_voucher_redemptions_${merchantId}`;
    const stored = localStorage.getItem(key);
