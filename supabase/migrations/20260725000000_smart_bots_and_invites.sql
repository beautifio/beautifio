...
('b0000000-0000-0000-0000-00000000001e', 'bot-s04@beautifio-bot.local', 'Dian Permana',   'https://api.dicebear.com/7.x/initials/svg?seed=DP4', 'Petani organik', true, 15, '{"disc":{"primary":"S","secondary":"C"},"speed":{"min":3500,"max":5000},"reactions":{"win":["Hasil panen bagus.","Mantap."],"lose":["Sabar.","Panen berikutnya."],"draw":["Adil."]},"rematch_max":2,"rematch_accept_rate":0.35}'),
...
('b0000000-0000-0000-0000-000000000020', 'bot-s06@beautifio-bot.local', 'Andi Cahyono',  'https://api.dicebear.com/7.x/initials/svg?seed=AC1', 'Sopir taksi 20 tahun', true, 45, '{"disc":{"primary":"S","secondary":"C"},"speed":{"min":3000,"max":5000},"reactions":{"win":["Sampai tujuan.","Mantap mas/mbak."],"lose":["Macet dikit.","Lain kali gas."],"draw":["Macet total."]},"rematch_max":3,"rematch_accept_rate":0.5}'),
...
('b0000000-0000-0000-0000-000000000022', 'bot-s08@beautifio-bot.local', 'Joni Tarigan',   'https://api.dicebear.com/7.x/initials/svg?seed=JT1', 'Tukang kayu', true, 55, '{"disc":{"primary":"S","secondary":"C"},"speed":{"min":3000,"max":5000},"reactions":{"win":["Pas ukurannya.","Good."],"lose":["Kurang pas.","Ukur ulang."],"draw":["50-50."]},"rematch_max":2,"rematch_accept_rate":0.45}'),
